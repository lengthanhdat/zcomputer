    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-xl shadow-gray-900/20 p-8 flex flex-col justify-between relative overflow-hidden text-white">
          ...
          <Link href="/admin/inventory" className="relative z-10 w-full bg-primary text-white font-bold py-4 px-6 rounded-xl text-center hover:bg-primary transition-colors flex items-center justify-center gap-2 shadow-lg shadow-primary">
