  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link 
          href="/admin/news/new" 
          className="bg-primary hover:bg-primary text-white px-4 py-2 rounded-lg flex items-center gap-2 transition"
        >
          <Plus size={20} />
        ...
        <div className="overflow-x-auto">
          <table className="whitespace-nowrap min-w-max w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td colSpan={6} className="p-4 md:p-8 text-center text-gray-500">
