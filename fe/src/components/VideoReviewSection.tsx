    ...
    <div className="bg-black rounded-[32px] shadow-[0_10px_30px_rgba(0,0,0,0.15)] overflow-hidden group relative aspect-[9/16] border-[6px] border-gray-900 transition-transform duration-500 hover:scale-[1.03] hover:shadow-[0_20px_40px_rgba(220,38,38,0.2)]">
      ...
      <div className="absolute top-4 left-4 right-4 flex items-center gap-3 z-10 pointer-events-none">
        <div className="relative">
          <Image src="/logo-full.jpg" alt="ZComputer" width={36} height={36} className="w-9 h-9 rounded-full object-contain bg-white shadow-lg border border-white/50" />
      ...
      {!isPlaying && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-white/20 backdrop-blur-md rounded-full border border-white/30 group-hover/play:bg-primary transition-colors duration-300 shadow-[0_0_20px_rgba(0,0,0,0.5)]"></div>
        ...
        <div className="absolute bottom-6 left-5 right-5 z-20">
          {video.product_id ? (
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 w-full py-3 bg-white/10 hover:bg-primary text-white border border-white/20 hover:border-primary rounded-xl font-bold text-sm backdrop-blur-md transition-all shadow-[0_8px_16px_rgba(0,0,0,0.4)]"
            >
