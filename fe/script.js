...
const startRightColumn = content.indexOf('          {/* Right Column: Sidebar (Similar Products) */}');
const endRightColumn = content.indexOf('        </div> {/* End Right Column */}') + '        </div> {/* End Right Column */}'.length;

content = content.substring(0, startRightColumn) + minimalSidebar + content.substring(endRightColumn);
